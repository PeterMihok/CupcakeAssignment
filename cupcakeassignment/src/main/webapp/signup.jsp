            ...
            <div class="row">
                <div class="box">
                    ...
                    <div class="alert alert-danger">
                        <strong>Error</strong> Username does not match a password!
                    </div>
                    <%}%>
                    <div class="col-lg-12">
                        <hr>
                        ...
                        <hr>
                        <p>We kindly ask you for login.</p>
                        <form name="SignUpForm" role="form" method="POST" action="Servlet">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="phone" class="form-control" name="phone" placeholder="+45 12 34 56 78">
                                </div>
                                <div class="form-group col-md-4">
